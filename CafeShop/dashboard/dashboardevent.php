    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            <div class="animated fadeIn">
                <div class="row" >
                    <h2>Thêm tin mới</h2><br>       
                    <form method="post" action="dashboardaction.php"><br><br>
                        <h4>tiêu đề : </h4> <input type="text" name="title">
                        <h4>Ảnh chủ đề : </h4> <input type="text" name="images">
                        <h4>Nội dung : </h4> <textarea name="content" class="ckeditor" rows="7" cols="10" id="ckedit"></textarea>

    
                        
                        <input type="submit" name="insert" value="Hoàn thành">
